...
export function SlackIcon({ className }: IconProps) {
  return (
    <svg className={className} data-testid="slack-icon" fill="currentColor" viewBox="0 0 24 24">
...
export function LinearIcon({ className }: IconProps) {
  return (
    <svg className={className} data-testid="linear-icon" fill="currentColor" viewBox="0 0 100 100">
      <path d="M1.22541 61.5228c-.2225-.9485.90748-1.5459 1.59638-.857L39.3342 97.1781c.6889.6889.0915 1.8189-.857 1.5964C20.0515 94.4522 5.54779 79.9485 1.22541 61.5228Z" />
      <path d="M.00189135 46.8891c-.01764375.2833.08887215.5599.28957165.7606L52.3503 99.7085c.2007.2007.4773.3072.7606.2896 2.3692-.1476 4.6938-.46 6.9624-.9259.7222-.1483.9826-1.0383.4617-1.5593L2.48723 39.4651c-.52097-.521-1.41108-.2605-1.55939.4617-.46584 2.2686-.778204 4.5932-.925945 6.9623Z" />
      <path d="M4.21093 29.7054c-.16649.3738-.08169.8106.20765 1.1l64.77602 64.776c.2894.2894.7262.3742 1.1.2077 1.7861-.7956 3.5171-1.6927 5.1855-2.684.5379-.3197.6238-1.0639.1807-1.507L8.40234 24.3393c-.44311-.4431-1.18731-.3572-1.50701.1807-.99125 1.6684-1.88823 3.3994-2.6844 5.1854Z" />
      <path d="M12.6587 18.074c-.3701-.3701-.3997-.9637-.0532-1.3568C21.8716 6.30623 35.1685 0 49.9999 0 77.6142 0 100 22.3858 100 50c0 14.8315-6.3062 28.1283-16.7172 37.3945-.3931.3465-.9867.3169-1.3568-.0532L12.6587 18.074Z" />
    </svg>
  );
}

...
| ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| **Web**    | The `Plan` toggle in the composer is OFF. Shadow mode by default: the classifier scores what you've typed for calibration, but the session still starts direct until classifier mode is promoted for Web. | Click `Plan` before submitting. The model selector swaps to the deployment's plan model. A click always wins over the classifier. | Leave the toggle OFF, or write a small, well-scoped request once classifier mode is promoted.    |
